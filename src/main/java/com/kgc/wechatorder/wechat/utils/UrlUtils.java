...
/**
 * Created By Ivan_ldp@163.com on 2019/9/15 14:40
 */
public class UrlUtils {
    /**
     * 向指定 URL 发送POST方法的请求 * * @param url 发送请求的 URL * @param paramMap 请求参数 * @return 所代表远程资源的响应结果
     */
